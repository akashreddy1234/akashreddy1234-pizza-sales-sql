...
## 📌 Project Overview
This project analyzes pizza sales data using **MySQL**. It answers business questions like total revenue, most popular pizzas, sales distribution, and percentage contributions.
...
✅ This project gives a complete SQL case study on a pizza store dataset.
